...
<head>
  ...
  <title>Hổ mới - Mạng xã hội SV</title>
  ...
  <header class="main-header">
    ...
    <a href="{{url('')}}" class="logo">
      ...
      <span class="logo-lg"><b>Homoi</b> 68 - {{Auth::user()->rule}}</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{url('m/member')}}/{{Auth::user()->linkprofile}}" class="btn btn-default btn-flat">Profile</a>
                </div>
